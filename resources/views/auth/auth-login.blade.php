      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Sistem Koperasi</span></h4>
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <div class="invalid-feedback">
                  Isi dengan password yang anda gunakan
                </div>
              </div>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Sistem Koperasi Simpan Pinjam. Made with 💙 by Stisla
              <div class="mt-2">
